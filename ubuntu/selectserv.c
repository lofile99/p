...
sendto(socket_fd, "REQUEST FOR WINDOW SIZE", sizeof("REQUST FOR WINDOW
SIZE"), 0, (struct sockaddr * ) & clientaddr, sizeof(clientaddr));
printf("\nWaiting for the window size\n");
recvfrom(socket_fd, (char * ) & windowsize, sizeof(windowsize), 0, (struct sockaddr * ) &
clientaddr, & len);
cls();
...
sendto(socket_fd, (char * ) & totalpackets, sizeof(totalpackets), 0, (struct sockaddr * ) &
clientaddr, sizeof(clientaddr));
recvfrom(socket_fd, req, sizeof(req), 0, (struct sockaddr * ) & clientaddr, & len);
printf("\nSending total number of frames\n");
sendto(socket_fd, (char * ) & totalframes, sizeof(totalframes), 0, (struct sockaddr * ) &
clientaddr, sizeof(clientaddr));
recvfrom(socket_fd, req, sizeof(req), 0, (struct sockaddr * ) & clientaddr, & len);
...
recvfrom(socket_fd, (char * ) & acknowledgement, sizeof(acknowledgement), 0, (struct
