...
sendto(client_socket_fd, "HI IAM CLIENT.", sizeof("HI IAM CLIENT."), 0, (struct sockaddr *
...
sendto(client_socket_fd, (char * ) & windowsize, sizeof(windowsize), 0, (struct sockaddr * ) &
serveraddr, sizeof(serveraddr));
cls();
printf("\nWaiting for the server response\n");
recvfrom(client_socket_fd, (char * ) & totalpackets, sizeof(totalpackets), 0, (struct sockaddr * )
& serveraddr, & len);
printf("The total packets are:%d\n", totalpackets);
sendto(client_socket_fd, "RECEIVED.", sizeof("RECEIVED."), 0, (struct sockaddr * ) &
serveraddr, sizeof(serveraddr));
recvfrom(client_socket_fd, (char * ) & totalframes, sizeof(totalframes), 0, (struct sockaddr * ) &
serveraddr, & len);
...
recvfrom(client_socket_fd, (char * ) & f1, sizeof(f1), 0, (struct sockaddr * ) & serveraddr, &
len);
printf("Received frame %d \n\nEnter to send negative acknowledgement for the following
packets.\n ", framesreceived);
j = 0;
m = 0;
k = l;
...
framesreceived++;
sendto(client_socket_fd, (char * ) & acknowledgement, sizeof(acknowledgement), 0, (struct
